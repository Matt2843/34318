...
public interface GeneralProperties {
	...
	public static Dimension panelRightTopSize = new Dimension(panelRightSize.width, panelRightSize.height/8*7);
	public static Dimension panelRightBottomSize = new Dimension(panelRightSize.width, panelRightSize.height/8);
